...
import chromadb
from src.pricer.agents.planning_agent import PlanningAgent
from src.pricer.agents.deals import Opportunity
...
class DealAgentFramework:
    DB = str(project_root / "products_vectorstore")
    MEMORY_FILENAME = str(project_root / "memory.json")
